...
if __name__ == "__main__":
    ...
    print("***Stds***")
    print(f"Pandas rolling stds time = {timeit.timeit(add_rolling_std_pandas, number=1)}")
    print(f"Polars rolling stds time = {timeit.timeit(add_rolling_std_polars, number=1)}")